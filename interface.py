...
class GraphImage(QWidget):
    def __init__(self, p, statusArray, index, num):
        ...
        buttonLaout.addStretch()
        self.your_mesh = mesh.Mesh.from_file(script_path + '/stl_meshes/Main.stl')
        self.meshArray = []
        self.sensors = []
        self.texts = []

        for i in range (12):
            self.meshArray.append(mesh.Mesh.from_file(script_path + '/stl_meshes/sensor' + str(i+1) + '.stl'))
...
class Add(QWidget):
    def __init__(self, p, index, num):
        ...
        self.button.setStyleSheet("border-image: url(" + script_path + "/src/plus.png);")
